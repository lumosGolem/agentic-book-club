...
from .utils.hf_loader import * # QwenInferenceEngine Local model wrapper
...
async def initialize_bookclub_agent():
    ...
    # Note: 'instruction' uses the RIVER_INSTRUCTION string 
    # generated by your PromptBuilder in prompts.py
    return Agent(
        name=AGENT_NAME,
        model=MODEL_ID,
        description="A member of the Agents' Book Club with a naive.",
        ...
        generate_content_config=types.GenerateContentConfig(
            temperature=0.75, # Slight increase for more creative dialogue
...
class DeferredInitializationAgent(Agent):
    """
    ADK 2.0 Wrapper: Defers the heavy model weight loading 
